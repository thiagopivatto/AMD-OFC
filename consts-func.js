...
const { wait, getExtension, h2k, generateMessageID, getGroupAdmins, getRandom, banner, banner2, banner3, infopd, success, start, close, temporizador, cmdadd, addMetadata, chyt } = require('./armor/functions.js'); // FUNÇÕES NESCESSARIAS PRA FUNFAR ALGUMAS COISAS
